...
function exp_label_camadas_COHABblocos_cohab_1_eval_expression(context) {
    // bloco + '\n' + cep

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('bloco')  + '\n') + feature.get('cep') );
    } else {
        return ((feature.get('bloco')  + '\n') + feature.get('cep') );
    }
}
...
function exp_label_camadas_COHABcadastros_cohabpontos_7_eval_expression(context) {
    // 'cadastro: ' + cadastro + '\n' + 'N: ' + numero + ' - ' + complement

    var feature = context.feature;
    
    if (feature.properties) {
        return (((((('cadastro: ' + feature.get('cadastro') ) + '\n') + 'N: ') + feature.get('numero') ) + ' - ') + feature.get('complement') );
    } else {
        return (((((('cadastro: ' + feature.get('cadastro') ) + '\n') + 'N: ') + feature.get('numero') ) + ' - ') + feature.get('complement') );
    }
}