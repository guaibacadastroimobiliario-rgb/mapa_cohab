...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 28, minZoom: 16
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([-5714910.354547, -3515751.036479, -5714729.190427, -3515654.473373], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_camadas_COHABbusca_enderecos_6,
    colName: 'ENDERECO_IMOVEL',
    zoom: 20,
    collapsed: true,
    map: map,
    maxResults: 5,
